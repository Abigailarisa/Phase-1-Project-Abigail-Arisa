...
//pokemon.id is getting set to i bc when on.click on pokemon name going to get the info based on the id
//which is the number in our pokedex and populate the left side(pokeinfo box)
...
// on.click pokemon name populate the data in left side
    ...
    //adding bulbasaurs info on.load bc he's the first pokemon
